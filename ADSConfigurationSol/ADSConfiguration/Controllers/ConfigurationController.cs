...
namespace ADSConfiguration.Controllers
{
    ...
    public class ConfigurationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Subscribe([FromBody] SubscribeModel subscribe)
        {
            ...
            if (configs == null)
            {
                _logger.LogInformation("Servicio subscrito, pero no tiene configuraciones parametrizadas");
                return Ok("Servicio subscrito, pero no tiene configuraciones parametrizadas");
            }
